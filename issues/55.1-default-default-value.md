...
+SemanticParameter[optional: false][writable: Boolean]
+	::= SemanticKey? SemanticVariable SemanticType;
+SemanticParameter[optional: true][writable: Boolean]
+	::= SemanticKey? SemanticVariable SemanticType SemanticExpression?;
```
...
+	:= (SemanticParameter[optional=false][writable=false]
		Decorate(Type)
	);
...
+	:= (SemanticParameter[optional=false][writable=true]
		Decorate(Type)
	);
...
+Decorate(ParameterFunction<-Named><+Optional> ::= "_" "?" ":" Type) -> SemanticParameter
+	:= (SemanticParameter[optional=true][writable=false]
+		Decorate(Type)
...
+Decorate(ParameterFunction<-Named><+Optional> ::= "mut" "_" "?" ":" Type) -> SemanticParameter
+	:= (SemanticParameter[optional=true][writable=true]
+		Decorate(Type)
+		(SemanticConstant[value=null])
+	);
+Decorate(ParameterFunction<-Named><+Optional> ::= "mut" IDENTIFIER "?" ":" Type) -> SemanticParameter
