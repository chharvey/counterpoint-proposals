...
+	|          "var"? "$"? ("_" | IDENTIFIER) <Optional->(":" Type)  <Optional+>("?:" Type | ":" Type "?=" Expression<+Block><-Break><-Return>);
+	| Word "=" "var"?      ("_" | IDENTIFIER) <Optional->(":" Type)  <Optional+>("?:" Type | ":" Type "?=" Expression<+Block><-Break><-Return>);
;
```
